...
class ControllerPaymentOPCreditCard extends Controller {
	...
	public function index() {
		...
		$data['text_code_online'] = $this->language->get('text_code_online');
		$data['text_code_local'] = $this->language->get('text_code_local');
		...
		if (isset($this->request->post['op_creditcard_code'])) {
			$data['op_creditcard_code'] = $this->request->post['op_creditcard_code'];
		} else {
			$data['op_creditcard_code'] = $this->config->get('op_creditcard_code');
		}
